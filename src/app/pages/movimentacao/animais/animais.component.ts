...
export class AnimaisComponent implements OnInit {
  ...
  constructor() {
    ...
    this.dataJulgamentoExtensa = '797 dia(s) ou 26 mês(es)'; //TODO: Calcular a data do julgamento extensa de acordo com a [Data de Julgamento]
    this.sisbov = ' '; //TODO: Preencher com o [Sisbov] do animal
    this.situacoes = ' REB / CDN / CAI'; //TODO: Preencher com as [Situações] do animal

    this.statusSelecionado = this.status[0]; //TODO: Preencher com o [Status] do animal

    this.situacaoReprodutivaDoAnimal = this.situacoesReprodutivas[0]; //TODO: Preencher com a [Situação Reprodutiva] do animal
    ...
    this.nomePai = 'TestePai'.toUpperCase(); //TODO: Preencher com o [Nome] do Pai do animal
